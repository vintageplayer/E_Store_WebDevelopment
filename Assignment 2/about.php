...
<body>
	...
	<div class="container" style="margin-top: 80px">
		<div class="row">
			<div class="col-sm-4">
				<div class="panel">
					<div class="panel-heading"><h5>WHO WE ARE</h5></div>
					<div class="panel-body"> Stuff to be added</div>
				</div>
			</div>
			<div class="col-sm-4">
				<div class="panel">
					<div class="panel-heading"><h5>OUR HISTORY</h5></div>
					<div class="panel-body">Stuff to be added</div>
				</div>
			</div>
			<div class="col-sm-4">
				<div class="panel">
					<div class="panel-heading"><h5>OPPORTUNITIES</h5></div>
					<div class="panel-body">Stuff to be added</div>
				</div>
			</div>
		</div>
